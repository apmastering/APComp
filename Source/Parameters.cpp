...
juce::AudioProcessorValueTreeState::ParameterLayout APComp::createParameterLayout() {
    ...
    params.push_back (std::make_unique<juce::AudioParameterFloat> ("threshold",     "Threshold",        -60.0f, 6.0f,   0.0f));
    ...
    params.push_back (std::make_unique<juce::AudioParameterFloat> ("ceiling",       "Ceiling",          0.3f,   3.0f,   1.2f));
